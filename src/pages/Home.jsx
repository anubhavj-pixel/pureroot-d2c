  ...
  return (
    <div>
      ...
      <section className="relative bg-[#f0ebe3] overflow-hidden">
        <div className="max-w-5xl mx-auto px-8 md:px-20 py-24 md:py-36 flex flex-col md:flex-row items-center gap-12">
      ...
      <section className="border-y border-[#e8e3da] bg-white">
        <div className="max-w-5xl mx-auto px-8 md:px-20 py-6 grid grid-cols-1 md:grid-cols-3 gap-6 text-center text-sm text-[#6b5e52]">
      ...
      {/* Featured products */}
      <section className="max-w-5xl mx-auto px-8 md:px-20 py-20">
